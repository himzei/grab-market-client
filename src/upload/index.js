  ...
  return (
    <div id="upload-container">
      <Form name="상품 업로드" onFinish={onSubmit}>
        ...
        <Form.Item
          name="seller"
          rules={[{ required: true, message: "판매지 이름 넣어주세요" }]}
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "상품이름을 입력해 주세요" }]}
        >
          <Input
            className="upload-name"
            size="large"
        ...
        <Form.Item
          name="description"
          label={<div className="upload-label">상품 섦명</div>}
          rules={[{ required: true, message: "상품 소개를 넣어주세요" }]}
        >
          <Input.TextArea
            size="large"
